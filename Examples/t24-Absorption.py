...
task = AbsorptionTask(
    ...
    bsedmat_fname='23-Kernel/bsedmat',  # Change to 23-Kernel/bsedmat.h5 if BGW is compiled with HDF5
    bsexmat_fname='23-Kernel/bsexmat',  # Change to 23-Kernel/bsexmat.h5 if BGW is compiled with HDF5
